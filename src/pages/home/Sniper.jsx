...
const simpledata = [
  {
    ...
    description:
      "Capitalise on maximum available trade opportunities at once, enhancing potential profit.",
  },
  {
    heading: (
      <>
    ...
    description:
      "Utilise diverse market conditions on different exchanges to optimise trade outcomes.",
  },
  {
    heading: (
      <>
    ...
    description:
      "Boost trading activity and returns by increasing simultaneous trade capacity",
  },
];
