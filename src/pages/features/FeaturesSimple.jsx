...
const workData = [
  {
    ...
    name: "Simultaneous Trade Execution",
    description:
      "Capitalises on maximum available trade opportunities at once, enhancing potential profit.",
  },
  {
    imgIccon: "/images/Features/features_2.svg",
    name: "Optimal Wallet Utilisation",
    description:
      "Leverages your wallet balance across multiple exchanges for better performance and efficiency.",
  },
  {
...

  {
    ...
    name: "Maximised Trading Opportunities",
    description:
  ...
  },
  {
    ...
    description:
      "Designed for high performance, ensuring quick and effective trade executions across various platforms.",
  },
];
      ...
      <FeaturesSimpleStyleBox>
        <Grid container spacing={2} alignItems="center">
          <Grid item lg={4} sm={12} md={4} xs={12}>
            ...
            >
              Sniper Auto Trade is an advanced feature which capitalises on
              maximum available trade opportunities simultaneously, leveraging
              your wallet balance across multiple exchanges for optimal
              performance. Users retain full control and are responsible for all
              trading decisions made using Bitedge.app.
            </Typography>
